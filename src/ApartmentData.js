const apartments = [
  ...
  },
  {
    ...
    coverImg:
      'https://mainwprentals.b-cdn.net/wp-content/uploads/2017/01/xx.jpg',
  },
  {
    id: '6',
    ...
    forRent: 'Shared room',
    description:
      'Beautiful 3rd floor P/House w/in a short walk/drive to restaurants, stores, and public trans. Private room/bath featuring top amenities. HDTV, internet, biz center (in the room), washer/dryer, wine fridge, gas fireplace, surround sound, private roof deck. One bus ride away from the subway. Wifi, eat-in kitchen, cable shops, warm host family, and a small lovable dog. Full breakfast included in price. Few stores at the end of the street, and minutes from Mattapan Square. One bus ride away from the subway. Wifi, eat-in kitchen, cable shops, warm host family, and a small lovable dog. Full breakfast included in price. Few stores at the end of the street, and minutes from Mattapan Square.',
    coverImg:
      'https://mainwprentals.b-cdn.net/wp-content/uploads/2015/04/3998-1170x921.jpg',
  },
  {
    id: '7',
    ...
    forRent: 'Private Room',
    description:
      'Located in the heart of Greenwich Village, This building is wonderfully situated on a quiet tree–lined street between West 4th Street and Bleecker Street, Close to all West Village eateries, shops and clubs, this building is just a short walk from Soho, Tribeca, Little Italy and Chinatown. The subway is only one block away. Newly renovated apartment – just 2 minutes-walk from Opera. It is the perfect location for daily sightseeing (excellent transport) and evening activity. Excellent location: restaurants, cafes, pubs (ruin-pubs as well), shops, museums are all within walking distance to make your stay even more enjoyable and comfortable.',
    coverImg:
      'https://mainwprentals.b-cdn.net/wp-content/uploads/2015/04/book_wide3-1170x900.jpg',
  },
  {
    id: '8',
    ...
    coverImg:
      'https://mainwprentals.b-cdn.net/wp-content/uploads/2015/04/book_wide_copy-1170x921.jpg',
  },
  {
    id: '9',
    ...
    coverImg:
      'https://mainwprentals.b-cdn.net/wp-content/uploads/2015/04/white_booking_version2-1170x921.jpg',
  },
  {
    id: '10',
    ...
    coverImg:
      'https://mainwprentals.b-cdn.net/wp-content/uploads/2015/04/rental2.jpg',
  },
];
